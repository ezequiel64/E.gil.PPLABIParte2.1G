...
int altaTrabajo(eTrabajo trabajo[],int tamtrabajo, eNotebook notebook[] ,int tamNote,eServicio servicio[] ,int tamServ,eMarca marca[],int tamMarca,eTipo tipo[],int tamTipo,int id)
...
{
	case 1:
		mostrarNotebooks(notebook,tamNote,marca,tamMarca,tipo,tamTipo);
		system("pause");
		break;
	case 2:
